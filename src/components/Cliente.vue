...
<template>
    <tr>
        ...
        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 ">
            <RouterLink :to="{name:'editar-clientes', params: { id: cliente.id }}" class="text-indigo-600 hover:text-indigo-900 mr-5">Editar</RouterLink>
            <button type="button" class="text-red-600 hover:text-red-900">Eliminar</button>
        </td>
    </tr>
</template>